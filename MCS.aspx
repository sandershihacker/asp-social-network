<%@ Page MasterPageFile="~/MasterPage.master" Title="MCS"%>

<asp:Content ContentPlaceHolderID="CPH1" runat="server">
    <h1 class="pageHeader">Mellon College of Science</h1>
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            SelectCommand="SELECT * FROM Users WHERE school = 'MCS' AND photo = 'true'">
        </asp:SqlDataSource>
